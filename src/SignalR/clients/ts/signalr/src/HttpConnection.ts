...
export class HttpConnection implements IConnection {
  ...
  private _gatewayTokenFactory?: () => string | Promise<string>;
  ...
  private async _startInternal(transferFormat: TransferFormat): Promise<void> {
    ...
    this._gatewayTokenFactory = this._options.gatewayTokenFactory;
  ...
  private _constructTransport(transport: HttpTransportType): ITransport {
    switch (transport) {
      case HttpTransportType.WebSockets:
        ...
        return new WebSocketTransport(this._httpClient, this._accessTokenFactory, this._gatewayTokenFactory, this._logger, this._options.logMessageContent || false, this._options.WebSocket, this._options.headers || {});
